...
\begin{itemize}
	...
	\begin{multicols}{2}
		\paragraph{before} In this article I want to present the approach I took to detect the features I needed.

		\paragraph{after} In this article I present an approach to detect the features we needed.
	\end{multicols}
